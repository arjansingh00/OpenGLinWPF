...
I have rebuilt the application using the same source code (with a few modifications) using a C++ CLR Class Library, because the original project that is from 2009 did not work on my computer. I use the compiled DLL in the C# WPF project.
